...
internal object LoggingMetricIdMapReleaseModule {
  ...
  fun provideFeatureNameToSuccessLatencyValueMetricIdMap():
    ...
    mapOf(
      ...
      PcsPrivateInferenceFeatureName.FEATURE_NAME_SCREENSHOTS_MEMORY_GENERATION to
        ValueMetricId.PCS_PI_SCREENSHOTS_MEMORY_GENERATION_LATENCY_MS,
      PcsPrivateInferenceFeatureName.FEATURE_NAME_SCREENSHOTS_RESPONSE_GENERATION to
        ValueMetricId.PCS_PI_SCREENSHOTS_RESPONSE_GENERATION_LATENCY_MS,
      PcsPrivateInferenceFeatureName.FEATURE_NAME_PSI_RESPONSE_GENERATION to
        ValueMetricId.PCS_PI_PSI_RESPONSE_GENERATION_LATENCY_MS,
      PcsPrivateInferenceFeatureName.FEATURE_NAME_PSI_MINI_RESPONSE_GENERATION to
  ...
  fun provideFeatureNameToFailureLatencyValueMetricIdMap():
    ...
    mapOf(
      ...
      PcsPrivateInferenceFeatureName.FEATURE_NAME_SCREENSHOTS_MEMORY_GENERATION to
        ValueMetricId.PCS_PI_SCREENSHOTS_MEMORY_GENERATION_FAILURE_LATENCY_MS,
      PcsPrivateInferenceFeatureName.FEATURE_NAME_SCREENSHOTS_RESPONSE_GENERATION to
        ValueMetricId.PCS_PI_SCREENSHOTS_RESPONSE_GENERATION_FAILURE_LATENCY_MS,
      PcsPrivateInferenceFeatureName.FEATURE_NAME_PSI_RESPONSE_GENERATION to
        ValueMetricId.PCS_PI_PSI_RESPONSE_GENERATION_FAILURE_LATENCY_MS,
      PcsPrivateInferenceFeatureName.FEATURE_NAME_PSI_MINI_RESPONSE_GENERATION to
