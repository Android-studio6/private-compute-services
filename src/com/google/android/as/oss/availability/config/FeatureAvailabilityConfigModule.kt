...
internal object FeatureAvailabilityConfigModule {
  @[Provides Singleton JvmStatic]
  fun provideFeatureAvailabilityConfigReader(
    flagManagerFactory: FlagManagerFactory,
    @GeneralExecutorQualifier executor: Executor,
  ): ConfigReader<FeatureAvailabilityConfig> =
    FeatureAvailabilityConfigReader(
